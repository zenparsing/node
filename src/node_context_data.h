...
#ifndef NODE_CONTEXT_MODULE_LOADER_OBJECT_INDEX
#define NODE_CONTEXT_MODULE_LOADER_OBJECT_INDEX 36
#endif
...
enum ContextEmbedderIndex {
  ...
  kModuleLoaderObject = NODE_CONTEXT_MODULE_LOADER_OBJECT_INDEX,
};
