...
function prepareMainThreadExecution(callback) {
...
function initializeESMLoader() {
  ...
  // TODO(zenparsing): These should be exposed in a different API.
  // The API should be feature-testable.
  process.addModuleLoaderPlugin = esm.addModuleLoaderPlugin;
  process.removeModuleLoaderPlugin = esm.removeModuleLoaderPlugin;
}
