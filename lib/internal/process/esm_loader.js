...
exports.addModuleLoaderPlugin = function(plugin) {
  return moduleLoader.addPlugin(plugin);
};

exports.removeModuleLoaderPlugin = function(plugin) {
  return moduleLoader.removePlugin(plugin);
};
